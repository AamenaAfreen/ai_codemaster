...
from game import Game, LOG_PATH
...
class SharingExample:
    ...
    Game(cm_glv07, g_glv, seed=seed, do_print=False, game_name="glv07-glv",
         cm_kwargs=cm_kwargs, g_kwargs=g_kwargs).run()
    ...
    Game(VectorCodemaster, VectorGuesser, seed=seed, do_print=False, game_name="vectorglv07-vectorglv",
         cm_kwargs=cm_kwargs, g_kwargs=g_kwargs).run()
    ...
    Game(cm_w2vglv07, g_w2vglv, seed=seed, do_print=False, game_name="w2vglv07-w2vglv",
         cm_kwargs=cm_kwargs, g_kwargs=g_kwargs).run()
    ...
    Game(VectorCodemaster, VectorGuesser, seed=seed, do_print=False, game_name="vectorw2vglv07-vectorw2vglv",
         cm_kwargs=cm_kwargs, g_kwargs=g_kwargs).run()
    ...
    Game(VectorCodemaster, VectorGuesser, seed=seed, do_print=False, game_name="vectorw2vglvglv07-vectorw2vglvglv",
         cm_kwargs=cm_kwargs, g_kwargs=g_kwargs).run()
    ...
    if not LOG_PATH.exists():
        ...
        with open(LOG_PATH, "r", encoding="utf-8") as f:
            for line in f:
                ...
                game_name = game_json.get("game_name")
                game_time = game_json.get("time_s", 0.0)
                game_score = game_json.get("total_turns")
